...
const translations = {
  zh: {
    ...
    "hero.how": "看看它如何工作",
    "hero.release": "当前为未签名 DMG 内测版 · Apple Silicon / Intel",
    ...
    "install.two.body": "按住 Control 点击应用，选择“打开”，然后再次确认。",
  ...
  en: {
    ...
    "hero.release": "Unsigned DMG beta · Apple Silicon / Intel",
    ...
    "install.two.body": "Control-click ContextCue, choose Open, then confirm once more.",
